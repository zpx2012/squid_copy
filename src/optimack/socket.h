...
unsigned int wait_SYN_ACK(unsigned char* remote_ip, unsigned char* local_ip, unsigned short remote_port, unsigned short local_port, unsigned int ack = 0, int timeout = 1, char* pkt_data = NULL);
unsigned int wait_data(unsigned char* remote_ip, unsigned char* local_ip, unsigned short remote_port, unsigned short local_port, unsigned int ack = 0, unsigned int seq = 1, char* pkt_data = NULL);
