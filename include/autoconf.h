...
/* The install prefix */
#define DEFAULT_PREFIX /root/squid
...
#define LT_DLSEARCH_PATH "/lib:/usr/lib:/usr/lib/x86_64-linux-gnu/libfakeroot:/usr/local/lib:/usr/local/ssl/lib:/usr/local/lib/x86_64-linux-gnu:/lib/x86_64-linux-gnu:/usr/lib/x86_64-linux-gnu"
...
#define PACKAGE_STRING "Squid Web Proxy 4.12"
...
#define SQUID_CONFIGURE_OPTIONS " '--prefix=/root/squid' '--disable-optimizations' '--enable-linux-netfilter' '--with-openssl' '--enable-ssl-crtd'"
